  ...
  return <div className="container ">
    ...
    <div className="col-4 ">
      ...
      <div className="form-group">
        ...
        <input type="range" className="form-control-range" min='0' max="999" id="border-radius-top" value={boxSize} onChange={e => setBoxSize(parseInt(e.target.value))} />
      </div>
      ...
      <div className="form-group">
        ...
        <input type="range" className="form-control-range" min='0' max={boxSize} id="border-radius-top" value={borderTop} onChange={e => setBorderTop(parseInt(e.target.value))} />
      </div>
      <div className="form-group">
        <label label-for="border-radius-left">Top - Right</label>
        <input type="range" className="form-control-range" min='0' max={boxSize} id="border-radius-left" value={borderRight} onChange={e => setBorderRight(parseInt(e.target.value))} />
      </div>
      <div className="form-group">
        <label label-for="border-radius-left">Bottom - Right</label>
        <input type="range" className="form-control-range" min='0' max={boxSize} id="border-radius-left" value={borderBottom} onChange={e => setBorderBottom(parseInt(e.target.value))} />
      </div>
      <div className="form-group">
        <label label-for="border-radius-bottom">Bottom - Left</label>
        <input type="range" className="form-control-range" min='0' max={boxSize} id="border-radius-bottom" value={borderLeft} onChange={e => setBorderLeft(parseInt(e.target.value))} />
      </div>
      <h3>Elevation</h3>
      <div className="form-group">
